...
namespace ClasesBase
{
    public class TrabajarVehiculo
    {
        ...
        ///METODOS PARA MARCA
        ///
        public static void insertar_marca(string marca)
        {
            SqlConnection cnn = new SqlConnection(ClasesBase.Properties.Settings.Default.AgenciaConection);

            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "INSERT INTO Marca (mar_nombre) values(@marca)";
            cmd.CommandType = CommandType.Text;
            cmd.Connection = cnn;
        ...
        public static void eliminar_marca(int id)
        {
            SqlConnection cnn = new SqlConnection(ClasesBase.Properties.Settings.Default.AgenciaConection);

            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "DELETE FROM Marca WHERE mar_id=@id";
            cmd.CommandType = CommandType.Text;
            cmd.Connection = cnn;
        ...
        public static void actualizar_marca(int id, string nombre)
        {
            SqlConnection cnn = new SqlConnection(ClasesBase.Properties.Settings.Default.AgenciaConection);

            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "UPDATE Marca set mar_nombre=@nombre WHERE mar_id=@id";
        ...
        public static DataTable listar_marcaTable()
        {
            SqlConnection cnn = new SqlConnection(ClasesBase.Properties.Settings.Default.AgenciaConection);

            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "SELECT ";
            cmd.CommandText += " mar_id as 'Id', ";
            cmd.CommandText += " mar_nombre as 'Nombre'";
            cmd.CommandText += " FROM Marca";
        ...
        ///METODOS PARA LINEA
        ///
        public static void insertar_linea(string linea, int idMarca)
        {
            SqlConnection cnn = new SqlConnection(ClasesBase.Properties.Settings.Default.AgenciaConection);

            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "INSERT INTO Linea (lin_nombre,mar_id) values(@linea,@idMarca)";
            cmd.CommandType = CommandType.Text;
            cmd.Connection = cnn;
        ...
        public static void eliminar_linea(int id)
        {
            SqlConnection cnn = new SqlConnection(ClasesBase.Properties.Settings.Default.AgenciaConection);

            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "DELETE FROM Linea WHERE lin_id=@id";
            cmd.CommandType = CommandType.Text;
            cmd.Connection = cnn;
        ...
        public static void actualizar_Linea(int id, string nombre, int idMarca)
        {
            SqlConnection cnn = new SqlConnection(ClasesBase.Properties.Settings.Default.AgenciaConection);

            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "UPDATE Linea set lin_nombre=@nombre, mar_id=@idMarca WHERE lin_id=@id";
        ...
        public static DataTable listar_lineaTable()
        {
            SqlConnection cnn = new SqlConnection(ClasesBase.Properties.Settings.Default.AgenciaConection);

            SqlCommand cmd = new SqlCommand();
           // cmd.CommandText = "SELECT lin_id as 'Id', lin_nombre as 'Linea' FROM Linea INNER JOIN Marca ON Linea.mar_id = Marca.mar_id";
            cmd.CommandText = "SELECT ";
            cmd.CommandText += " lin_id as 'Id' ,";
            cmd.CommandText += " lin_nombre as 'Linea',";
            cmd.CommandText += " M.mar_nombre as 'Marca', ";
            cmd.CommandText += " M.mar_id as 'Id Marca' ";
            cmd.CommandText += " FROM Linea as L";
